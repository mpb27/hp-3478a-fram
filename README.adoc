...
The schematic, layout, and BOM are complete, but the PCB has not been verified to work.

*Status:* Awaiting PCB delivery and sourcing of parts.
====


== Main changes

* One resistor value (10kΩ) and one capacitor value (0.1μF) - both 0603.
...
== Future Work
* Verify the PCB works as expected.
* Increase resistor values to 47kΩ -- the 10kΩ resistors are overkill.
* Add OSHW license and attribution.
